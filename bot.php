...
// Bot criado por @drakekk1 código original para o @drakekk1
...
define ('5059987771:AAHjZHJ8do_dZqo2_-JJwIoWZIen0OW6Rmk', $token); // token do bot criado no @botfather
...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'DONO @DRAKEKK1 por @drakekk1'
	]);
